          ...
          infowindow.open($scope.map, marker);
             ...
             for(j = 0; j < $scope.directorList.length; j++){
                 if ($scope.directorList[j].country===locations[i].CountryName) {
                    ...
                    document.getElementById("dirImg").setAttribute("src",$scope.directorList[j].profilePic);
                    document.getElementById("dirName").innerText=$scope.directorList[j].name;
                    document.getElementById("dirCountry").innerText=$scope.directorList[j].country;
